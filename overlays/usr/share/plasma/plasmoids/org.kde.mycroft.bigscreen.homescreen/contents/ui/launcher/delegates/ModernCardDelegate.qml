...
Item {
    ...
    Rectangle {
        ...
        LinearGradient {
            ...
            gradient: Gradient {
                GradientStop { position: 0.0; color: Qt.rgba(1.0, 1.0, 1.0, cardRoot.isCurrent ? 0.12 : 0.05) }
                GradientStop { position: 0.4; color: Qt.rgba(1.0, 1.0, 1.0, 0.0) }
                GradientStop { position: 1.0; color: Qt.rgba(0.0, 0.0, 0.0, cardRoot.isCurrent ? 0.10 : 0.25) }
            }
        }
