.PHONY: help install customize install-extras cec-poweron check-updates clean usb-installer
...
help:
	...
	@echo "  make usb-installer   Create bootable Ubuntu 24.04 autoinstall USB"
...
usb-installer:
	sudo ./scripts/install-ubuntu-server.sh $(USB)
